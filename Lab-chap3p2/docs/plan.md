...
## 👥 CHI TIẾT KẾ HOẠCH & TỶ LỆ ĐÓNG GÓP (6 THÀNH VIÊN THỰC HIỆN)

> **Lưu ý phân chia tỷ lệ %**: Bài Lab 4 được thực hiện và chia đều cho **6 thành viên**: **Thông, Đức, Duy, Thọ, Huy, Phước** (mỗi người đóng góp **16.67%**, hoàn thành 100% nhiệm vụ được giao). Thành viên **Vinh không tham gia bài lab này (0% đóng góp)**.

### 1️⃣ Thành viên 1: Thông (16.67% - Phần I + II.1 + II.2)
...
### 2️⃣ Thành viên 2: Đức (16.67% - Phần II.3 + II.4)
...
### 3️⃣ Thành viên 3: Duy (16.67% - Phần II.5)
...
- **Kế hoạch thực hiện**:
  ...
  - Tính toán các chỉ số Accuracy, Sensitivity, Specificity.
...
### 4️⃣ Thành viên 4: Thọ (16.67% - Phần IV)
...
### 5️⃣ Thành viên 5: Huy (16.67% - Phần III.1 + Cải tiến code)
- **Mục tiêu**: Khảo sát các phương pháp băm Wavelet khác nhau & Cải tiến code.
- **Kế hoạch thực hiện**:
  - Cài đặt 3 phương pháp băm: PP1 (LL Hash), PP2 (Detail Energy Hash), PP3 (Combined Hash).
  - Cải tiến hàm `wavelet_hash_enhanced()` hỗ trợ điều chỉnh `hash_size`, xử lý ngoại lệ an toàn và chuẩn hóa hệ số.
  - Khảo sát 4 họ Wavelet (`haar`, `db4`, `sym4`, `coif2`) trên tập test, đo lường Accuracy (%) và Latency (ms/ảnh).

### 6️⃣ Thành viên 6: Phước (16.67% - Phần III.2)
...
### ❌ Thành viên không tham gia: Vinh (0.00%)
- Thành viên Vinh không tham gia bài Lab 4 (không tính % đóng góp).
